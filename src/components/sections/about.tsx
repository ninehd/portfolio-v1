            ...
            <div className="container">
                ...
                <TextPicture>
                    ...
                    <p>Hello I'm William Dhenin, a software engineer based in Toulouse, France.
                        Ever since my early years, I've been fascinated by computers, and my enthusiasm for technology has only grown over time.
                        I thrive on challenges, which is why I'm always eager to explore new technologies.
                        Building creative solutions is my passion, and although I primarily focus on Back-End development,
                        I consider myself a Full-Stack developer.</p>
                </TextPicture>
                <TextPicture>
                    <p>I currently work at Lyra Network, and I must say, it's an amazing place to be.
                        My primary focus is on developing innovative payment methods, while also ensuring the smooth functioning of existing ones.
                        As an autonomous individual with a keen eye for detail, I am confident in my ability to stay well-organized.</p>
                    <img src={payment} alt=""/>
                </TextPicture>
                <TextPicture>
                    <img src={foot} alt=""/>
                    <p>I'm a big fan of football, with a strong allegiance to AJ Auxerre and, of course, Toulouse FC.
                        ...
                        Additionally, I have a little passion for chess. I thoroughly enjoy both playing the game and watching top players in action.</p>
                </TextPicture>
            </div>
        </div>
    );
